...
init_viewer_runtimes_7();




export const HDFViewer = window.HDFViewer;
export const ViewerRuntime = window.HDFViewer?.components?.viewerPanel?.runtime ?? {};
export default ViewerRuntime;
