...
export const bootstrapApp = window.bootstrapApp;
export const renderApp = window.renderApp;
export const queueRender = window.queueRender;
export default window.HDFViewer?.app ?? {};